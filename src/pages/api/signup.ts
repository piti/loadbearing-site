...
It also lives in your Load-Bearing library — along with a builder file you can hand to your AI (it interviews you and sets the vault up with you):
${lib}
